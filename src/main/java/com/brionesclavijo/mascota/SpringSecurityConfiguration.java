...
public class SpringSecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
			...
			.antMatchers("/adopcion/galeria").hasAnyRole("USER","ADMIN")	
			.antMatchers("/adopcion/create").hasAnyRole("ADMIN")
			.antMatchers("/adopcion/list").hasAnyRole("ADMIN")
			.antMatchers("/adopcion/adoptar").hasAnyRole("USER")
